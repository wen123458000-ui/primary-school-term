...
from mycode.part_1.fs_utils import (
    wildcard_match,
    find_bfs,
    find_dfs,
    find_duplicates,
...
class TestFsUtils(unittest.TestCase):
    def setUp(self):
        ...
        self.fs.touch("/src/utils", "utils.py", 80)
    ...
    # 4. 查找重复文件名 find_duplicates
    def test_find_duplicates_has_dup(self):
        dup_names = find_duplicates(self.fs, "/")
        self.assertEqual(dup_names, ["utils.py"])
