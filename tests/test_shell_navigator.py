...
from src.core.shell_navigator import ShellNavigator
...
class TestShellNavigator(unittest.TestCase):
    ...
    def test_init_state(self):
        ...
        self.assertEqual(self.nav.history_stack.size(), 0)
        self.assertTrue(self.nav.history_stack.is_empty())
    ...
    def test_cd_into_exist_dir_success(self):
        ...
        self.assertEqual(self.nav.history_stack.size(), 1)
        self.assertEqual(self.nav.history_stack.peek(), self.fs.root)
    ...
    def test_cd_back_normal(self):
        ...
        self.nav.cd("usr")
        self.nav.cd("local")
        self.assertEqual(self.nav.history_stack.size(), 2)
